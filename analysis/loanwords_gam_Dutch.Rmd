...
```{r}
plotGAMSignificantSlopes(m0.dutch,"subtlexzipfscale","Frequency")
plotGAMSignificantSlopes(m0.dutch,"AoAscale","AoA")
plotGAMSignificantSlopes(m0.dutch,"phonlengthscale","length")
plotGAMSignificantSlopes(m0.dutch,"concscale","Concreteness")
```
